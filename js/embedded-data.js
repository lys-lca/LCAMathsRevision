window.LCAMathsData = {
    ...
    "diagrams": [
      {
        ...
        "description": "A value past the halfway point rounds up. A value before the halfway point rounds down.",
        "min": 18,
        "mid": 18.5,
        "max": 19,
        "point": 18.76,
        "label": "18.76 rounds to 19"
      },
      {
        "type": "percent-grid",
        "title": "Percent means out of 100",
        "description": "The shaded squares show 35 out of 100, which is 35%.",
        "filled": 35,
        "label": "35%"
      }
    ],
    ...
    "diagrams": [
      {
        "type": "discount-bar",
        "title": "Discount bar",
        "description": "Find the discount part first, then subtract it from the original price.",
        "price": 120,
        "percent": 25
      },
      {
        "type": "money-flow",
        "title": "Money question flow",
        "description": "Most money questions use the same three-step structure.",
        "steps": [
          "Original amount",
          "Find the part",
          "Add or subtract",
  ...
  "data/facts/measurement.json": {
    ...
    "diagrams": [
      {
        "type": "shape-formulas",
        "title": "Common shape formulas",
        "description": "Pick the formula that matches the shape in the question.",
        "shapes": [
          "rectangle",
          "circle",
          "cuboid",
      ...
      {
        "type": "scale-strip",
        "title": "Scale model thinking",
        "description": "A scale of 1:12 means every 1 cm on the model is 12 cm in real life.",
        "model": 1,
        "real": 12
      }
    ],
    ...
    "diagrams": [
      {
        ...
        "description": "Compare heights carefully and always check the scale on the axis.",
        "labels": [
          "Mon",
          "Tue",
          "Wed",
      ...
      },
      {
        ...
        "description": "Put the values in order, then find the middle value.",
        "values": [
          6,
          6,
          7,
      ...
      {
        "type": "outlier-chart",
        "title": "Spot an outlier",
        "description": "An outlier sits far away from the main group and needs explaining.",
        "values": [
          6,
          7,
          6,
  ...
  "data/facts/relationships.json": {
    ...
    "diagrams": [
      {
        "type": "line-graph",
        "title": "Straight-line relationship",
        "description": "Small containers worth EUR 0.15 each make a straight line because the rate is steady.",
        "xLabel": "containers",
        "yLabel": "euro",
        "points": [
          [
      ...
      },
      {
        "type": "table-pattern",
        "title": "Table pattern",
        "description": "Each row uses the same rule: number of items times the rate.",
        "headers": [
          "Small containers",
          "Refund"
        ],
    ...
    "diagrams": [
      {
        ...
        "description": "Add on-the-job and off-the-job phases separately before finding the total.",
        "phases": [
          {
            "label": "Phase 1",
            "value": "3 months",
      ...
      },
      {
        "type": "payslip-flow",
        "title": "Payslip flow",
        "description": "Gross pay becomes net pay after tax credits and deductions are applied.",
        "steps": [
          "Gross pay",
          "Gross tax",
          "Tax credits",
